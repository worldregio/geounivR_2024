---
title: "INTRODUCTION : POURQUOI APPRENDRE R ?"
subtitle: "1. Intérêt pédagogique"
...
# Importe les données
library(readxl)
data<-read_xls(path = "RP_Tunisie/data/don_del.xls",
              sheet = "data")
...
map<-st_read("RP_Tunisie/geom/map_del.geojson", quiet=T)
